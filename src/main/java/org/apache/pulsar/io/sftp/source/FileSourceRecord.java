 ...
 */
@Data
public class FileSourceRecord implements Record<byte[]> {
    ...
    public FileSourceRecord(File srcFile, int lineNumber, byte[] value) throws NoSuchAlgorithmException, IOException {
        ...
        this.setProperty(FILE_MODIFIED_TIME, String.valueOf(srcFile.lastModified()));
        this.setProperty(FILE_MD5, FileUtil.getFileMD5(srcFile));
    }
